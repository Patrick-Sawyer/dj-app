...
export function Mixer ({
  ...
  return (
    <Wrapper>
      <Eq>
        <ChannelEq deck={decks.deckA} glowColor={Colors.deckAGlow} label="DECK-A" color={Colors.deckA}/>
        <MainLevels decks={decks} />
        <ChannelEq deck={decks.deckB} label="DECK-B" glowColor={Colors.deckbGlow} color={Colors.deckB} />
      </Eq>
      <SliderWrapper>
